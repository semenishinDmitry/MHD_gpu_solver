...
public:
    State2D() = default;
    State2D(const double rho, const double mx, const double my, const double mz, const double E, const double Bx, const double By, const double Bz):
        rho(rho), mx(mx), my(my), mz(mz), E(E), Bx(Bx), By(By), Bz(Bz) {};

    double get_vx() const { return mx / rho; }
    double get_vy() const { return my / rho; }
    double get_vz() const { return mz / rho; }
};
...
public:
    ...
    PrimitiveState2D(const double rho, const double vx, const double vy, const double vz, const double E, const double Bx, const double By, const double Bz):
